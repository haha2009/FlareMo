...
const messages = {
  "zh-CN": {
    ...
    "list.emptyTitle": "这里还没有内容",
    "list.emptyDescription": "换个筛选条件，或者先写下一条记录。",
  ...
  "en-US": {
    ...
    "list.emptyTitle": "No notes yet",
    "list.emptyDescription": "Try another filter, or write the first note.",
