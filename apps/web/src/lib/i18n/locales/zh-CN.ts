...
const zhCN: Record<string, string> = {
  ...
  "txt_parse_meta": "解析网站信息（标题、封面、描述）",
  "txt_cover_card_add_hint": "点击添加封面图",
  "txt_cover_image": "封面图片",
  "txt_cover_upload_file": "从设备上传",
  "txt_cover_paste_url_placeholder": "粘贴图片链接...",
  "txt_untitled": "未命名",
  ...
  "txt_description": "项目介绍",
  "txt_entry_description": "项目介绍",
  "txt_entry_description_zh": "中文描述",
  "txt_entry_description_en": "英文描述",
  "txt_date_of_birth": "出生日期",
  "txt_nationality": "国籍",
  "txt_gender": "性别",
  "txt_document_type": "证件类型",
  "txt_document_number": "证件号码",
  "txt_issue_date": "签发日期",
  "txt_expiry_date": "有效期至",
  "txt_issuing_authority": "签发机关",
  "txt_document_info": "证件信息",
  "txt_translate": "翻译",
  "txt_switch_to_zh": "切换到中文",
  "txt_switch_to_en": "切换到英文",
  "txt_personal_info": "个人信息",
  "txt_address_info": "地址信息",
  "txt_payment_info": "支付信息",
  "txt_app_binding": "应用绑定",
  "txt_bind_app": "绑定应用",
  "txt_bound_note": "绑定笔记",
  "txt_email_address": "电子邮箱",
  "txt_app_package": "应用包名",
  "txt_app_name": "应用名称",
  "txt_bound_note_id": "绑定笔记 ID"
};
